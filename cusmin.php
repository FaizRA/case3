...
-->
						...
						<tr valign="top" class="wpex-custom-admin-screen-background-section">
							<th scope="row"><?php esc_html_e( 'Select Theme', 'text-domain' ); ?></th>
							<td>
								<?php $value = self::get_theme_option( 'select_example' ); ?>
								<select name="theme_options[select_example]">
									<?php
									$options = array(
										'1' => esc_html__( 'Grayscale 1', 'text-domain' ),
										'2' => esc_html__( 'Grayscale 2', 'text-domain' ),
										'3' => esc_html__( 'Grayscale 3', 'text-domain' ),
									);
